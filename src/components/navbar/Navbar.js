...
const Navbar = () => {
  ...
  const { signOut, userName, afflitedId, idLogged } = useContext(AuthContext)
              ...
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end shadow border border-0">
                    <li><Link className='dropdown-item' to={"/users/edit/" + idLogged}>Conta</Link></li>

                    <li><Link className='dropdown-item' to={"/users/editPassword/"}>Alterar Senha</Link></li>

                    <li><Link className='dropdown-item' to={"/affliteds/edit/" + afflitedId}>Configurações</Link></li>
