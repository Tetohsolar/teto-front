    ...
    <div className="d-flex flex-nowrap" id="sidebar-wrapper">
      <div className="d-flex flex-column flex-shrink-0 px-3 pt-4 sidebar">
        <ul className="nav nav-pills flex-column mb-auto list-g">
          <li className="my-1'">
            <Link to={"/"} className={`nav-link ${props.activeButtonHome}`} aria-current="page">
          ...
          <li className='my-1'>
            <Link to={"/customers"} className={`nav-link ${props.activeButtonCustomers}`}>
              <div className='d-flex align-items-center gap-2'>
          ...
          <li className='my-1'>
            <Link to={"/products"} className={`nav-link ${props.activeButtonProducts}`}>
              <div className='d-flex align-items-center gap-2'>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-basket2-fill" viewBox="0 0 16 16">
          ...
          <li className='my-1'>
            ...
            <button className={`nav-link ${props.activeButtonSingleBusiness}`} data-bs-toggle="modal" data-bs-target="#exampleModa2l">
              <div className='d-flex align-items-center gap-2'>
          ...
          <li className='my-1'>
            <Link to={"/settings"} className={`nav-link ${props.activeButtonSettings}`}>
              <div className='d-flex align-items-center gap-2'>
